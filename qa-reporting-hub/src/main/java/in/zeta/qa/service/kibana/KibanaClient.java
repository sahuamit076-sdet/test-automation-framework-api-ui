...
class KibanaClient {
    ...
    private static final Header HEADER_XSRF = new Header("osd-xsrf", "true");
    ...
    private Headers getDefaultHeaders() {
        return Headers.headers(CONTENT_TYPE_JSON, HEADER_XSRF, new Header("cookie", cookieHeader));
    }

    public Response openSearch(String payload) {
    ...
    public Response openSearchWithRetryUntilMatchedStrFound(String payload, String title) {
    ...
    public Response shortUrl(String longUrlPath) {
